...
export default function MedicineInfo(props) {
  ...
  async function getMedicineData() {
    ...
    let display = (
      <div>
        ...
        <p>Matières premières du produit: {data[2]}</p>
  ...
  function getSupplyChainStepContent(stepIndex) {
    switch (stepIndex) {
      case 0:
        return "Le médicament est au stade de la fabrication dans la chaîne d'approvisionnement.";
      case 1:
        return "Les médicaments collectés par le transporteur sont en route vers le grossiste.";
      case 2:
        return "Les médicaments actuellement chez le grossiste";
      case 3:
        return "Les médicaments sont collectés par le Transporteur ! En route vers la pharmacie.";
      case 4:
        return "Les médicaments sont livrés au pharmacie";
