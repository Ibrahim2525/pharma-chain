...
import bgImage from "../../components/images/Wholesaler.jpg";
import logo from "../../components/images/Wholesaler.jpg";
...
const routes = [
  {
    path: "/view-medicines",
    name: "Afficher médicaments reçus",
    icon: ViewItem,
